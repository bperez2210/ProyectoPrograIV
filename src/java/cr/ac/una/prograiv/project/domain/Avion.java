...
public class Avion  implements java.io.Serializable {
    ...
    public Avion(Integer aerolinea, int cantPasajeros, Date ultimaFecha, String ultimoUsuario) {
        this.aerolinea = aerolinea;
        this.cantPasajeros = cantPasajeros;
        this.ultimaFecha = ultimaFecha;
        this.ultimoUsuario = ultimoUsuario;
    }
    public Avion(Integer aerolinea, Integer anno, String modelo, String marca, int cantPasajeros, Integer cantAsientosPorFila, Integer cantFilas, Date ultimaFecha, String ultimoUsuario) {
       this.aerolinea = aerolinea;
       this.anno = anno;
       this.modelo = modelo;
       this.marca = marca;
